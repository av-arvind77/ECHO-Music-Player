...
import com.ooug.echo.adapters.MainScreenAdapter
...
class MainScreenFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        visibleLayout = view?.findViewById(R.id.visileLayout)
        noSongs = view?.findViewById(R.id.noSongs)
        nowPlayingBottomBar = view?.findViewById(R.id.hiddenBarMainScreen)
        songTitle = view?.findViewById(R.id.songTileMainScreen)
    ...
    private fun getSongsFromPhone(): ArrayList<Songs>{
        ...
        var songCursor = contentResolver?.query(songsUri, null, null,null, null)
